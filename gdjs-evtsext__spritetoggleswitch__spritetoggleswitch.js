...
{isConditionTrue_0 = eventsFunctionContext.getObjects("Object")[0]._getIsChecked();
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = !eventsFunctionContext.getObjects("Object")[0]._getPreviousIsChecked();
}
}
if (isConditionTrue_0) {
